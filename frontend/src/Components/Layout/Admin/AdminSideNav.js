            ...
            <Sidebar
                ...
                <Menu>
                    ...
                    <div className='' style={{ marginLeft: -7 }}>
                        ...
                        <MenuItem onClick={() => navigate('/admin/dashboard')} icon={<ChatIcon />} > Chat Management </MenuItem>
                        <MenuItem onClick={() => navigate('/admin/dashboard')} icon={<MDBIcon fas icon="bullhorn" />} > Announcement Management </MenuItem>
                        <MenuItem onClick={() => navigate('/admin/dashboard')} icon={<ManageAccountsIcon />} > User Management </MenuItem>
                        <MenuItem onClick={() => navigate('/admin/dashboard')} icon={<WorkspacesIcon />} > Forum Management </MenuItem>
