...
import { fetchGroupPosts, fetchTeachersPost, getAnnouncement } from '../../api/announcementsAPI'
...
const AnnouncementsListByGroup = () => {
                        ...
                        <MDBRow>
                            <MDBCol>
                                <Box sx={{ boxShadow: 5, py: 2, px: 3 }} className='d-flex gap-3'>
                                    <img style={{ height: 75, width: 75, objectFit: 'cover' }} src={group?.coverPhoto?.url || '/bullhorn.svg'} fluid />
                                    <Box>
                                        <Typography variant='h5'>{group.groupName} Announcements</Typography>
                                        <MDBBadge color='success' light>Group created by: {group.createdBy?.firstname} {group.createdBy?.lastname}</MDBBadge>
                                    </Box>
                                </Box>
...
export default AnnouncementsListByGroup