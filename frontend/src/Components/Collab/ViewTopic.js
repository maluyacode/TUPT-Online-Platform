...
import { Badge, Box, Button, Chip, Divider, IconButton, InputAdornment, Paper, TextField, Typography } from '@mui/material'
...
const ViewTopic = ({ setOpenRight, selectedPost }) => {
                    ...
                    <Box className='d-flex flex-row gap-2'>
                        ...
                        <div className='mt-1'>
                            <div className='d-flex gap-2'>
                                ...
                                <small style={{ fontSize: 12 }}>{computeTimeElapsed(topic.updatedAt)}</small>
                            </div>
